...
const WheelsSection = () => {
  const { visited, selectedWheels, wheels, setItem } = useContext(BuilderContext);
  ...
  return (
    <section className="wheels__section">
      ...
      <div className="wheels-section__picker-container">
          <WheelsPicker  onSelect={changeWheels} currentWheels={selectedWheels.model} allWheels={wheels.items} />
      </div>
    </section>
  );
};
